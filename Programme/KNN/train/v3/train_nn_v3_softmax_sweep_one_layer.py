# train_nn_v3_softmax_sweep_one_layer.py
# Trainingsprogramm
# 1 Hidden-Layers, Softmax, Optimierervariation
# Laufende Daten
...
def run_experiment(args):
	...
	wandb.init(project="KNN_v2_softmax_sweep_1layer")
	...
	X_test = numpy.array(X_test_2)
	y_train = numpy.array(y_train_2)
	y_test = numpy.array(y_test_2)
...
if __name__ == "__main__":
	...
	parser.add_argument(
		...
		"--model_name",
		type=str,
		default="v2_softmax_sweep_onelayer",
